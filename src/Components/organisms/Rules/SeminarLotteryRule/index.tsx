                    ...
                    <Blockquote.Root>
                        <Blockquote.Content>
                            <Stack>
                                ...
                                <Text>
                                    세미나실 1·2를 합쳐 <BlueMark>1·2·3지망별로 시간대 하나씩</BlueMark> 신청할 수 있습니다.
                                </Text>
                                <Text>
                                    조직당 최종적으로 <BlueMark>최대 한 시간대만 당첨</BlueMark>되며, 당첨된 조직의 나머지 신청은 삭제됩니다.
                                </Text>
                                <Text>
                                    1지망 무동방, 1지망 동방 보유, 2지망 무동방, 2지망 동방 보유, 3지망 무동방, 3지망 동방 보유 순서로 배정됩니다.
                                </Text>
                                <Text>
